...
$perintah = "select * from admin_asrama WHERE username = '$username' AND pass = '$pass'";
...
if ($row['username'] == $username and $row['pass'] == $pass) {
    ...
    header("location:../anggota/admin_anggota.php"); // jika berhasil login, maka masuk ke file anggota.php
